...
//             </p>
//             <p className="result-counts">
//               <FaCheckCircle className="icon success" /> Correct:{" "}
//               {correctCount} |{" "}
//               <FaTimesCircle className="icon danger" /> Incorrect:{" "}
//               {incorrectCount}
//             </p>

//             {score === questions.length && (
//               <div className="result-congrats">
//                 🎉 <strong>Congratulations!</strong> You answered all questions
//                 correctly!
//                 <br />
//                 You are eligible to win <strong>Rs. 200</strong> and 30 days
//                 access.
//               </div>
//             )}
